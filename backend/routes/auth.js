...
const {updateAvatar} = require("../controller/authController")
...
router.put("/account", authenticateUser, async (req, res) => {
...
router.put("/account/avatar", authenticateUser, upload.single("avatar"), updateAvatar)
